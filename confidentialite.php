...
<div class="confid-container">
	<div class="confid-inner">
	  ...
	  <ul>
	  </li>Personnaliser votre expérience et répondre à vos besoins individuels </br></li>
	    </li>Fournir un contenu publicitaire personnalisé </br> </li>
	    </li>Améliorer notre site Web </br> </li>
	    </li>Améliorer le service client et vos besoins de prise en charge </br> </li>
	    </li>Vous contacter par e-mail </br> </li>
	    </li>Administrer un concours, une promotion, ou un enquête </br></li>
	  </ul>
